...
<div id="calculator" tabindex="-1"
  ...
  <div id="calc-grid" class="tw-grid tw-grid-cols-4 tw-gap-[3px] tw-w-full">
    ...
    <button type="button" id="/"         onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-op">&divide;</button>

    {{-- Row 2: 7  8  9  × --}}
    <button type="button" id="7" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">7</button>
    <button type="button" id="8" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">8</button>
    <button type="button" id="9" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">9</button>
    <button type="button" id="*" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-op">&times;</button>

    {{-- Row 3: 4  5  6  − --}}
    <button type="button" id="4" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">4</button>
    <button type="button" id="5" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">5</button>
    <button type="button" id="6" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">6</button>
    <button type="button" id="-" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-op">&minus;</button>

    {{-- Row 4: 1  2  3  + --}}
    <button type="button" id="1" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">1</button>
    <button type="button" id="2" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">2</button>
    <button type="button" id="3" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">3</button>
    <button type="button" id="+" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-op">+</button>

    {{-- Row 5: 0  .  %  = --}}
    <button type="button" id="0" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">0</button>
    <button type="button" id="." onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-num">.</button>
    <button type="button" id="%" onclick="calEnterVal(this.uid)" class="calc-btn calc-btn-op">%</button>
