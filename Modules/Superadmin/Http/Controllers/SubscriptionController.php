...
class SubscriptionController extends BaseController
{
    ...
    protected function pay_stripe($business_id, $business_name, $package, $request)
    {
        ...
        $metadata = ['business_uid' => $business_id, 'business_name' => $business_name, 'stripe_email' => $request->stripeEmail, 'package_name' => $package->name];
    ...
    {
        $url = 'https://api.flutterwave.com/v3/transactions/'.$request->get('transaction_uid').'/verify';
        $header = [
    ...
    public function show($id)
    {
        ...
        $subscription = Subscription::where('business_uid', $business_id)
