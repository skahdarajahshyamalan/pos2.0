...
class BusinessController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin::business.index')
            ->with(compact('business_uid', 'packages', 'subscription_statuses', 'last_transaction_date'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            //created_by
            $business_details['created_by_uid'] = $request->session()->get('user.id');
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $products_id = Product::where('business_uid', $id)->pluck('id')->toArray();
            if (! empty($products_id)) {
                VariationLocationDetails::whereIn('product_uid', $products_id)->delete();
            }
            Transaction::where('business_uid', $id)->delete();

            Business::where('uid', $id)
                ->delete();
    ...
    public function toggleActive(Request $request, $business_id, $is_active)
    {
        ...
        Business::where('uid', $business_id)
    ...
    public function usersList($business_id)
    {
        ...
        if (request()->ajax()) {
            ...
            $users = User::where('business_uid', $business_id)
                        ->where('uid', '!=', $user_id)
    ...
    public function updatePassword(Request $request)
    {
        ...
        try {
            ...
            $user = User::findOrFail($request->input('user_uid'));
